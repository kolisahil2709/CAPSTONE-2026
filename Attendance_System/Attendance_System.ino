...
void setup() {
#ifdef WITHOUT_HARDWARE
  tftWasPowerCycled = true; // Bypass all TFT drawing functions
#endif
...
#else
  useEEPROM = false;
  Serial.println("ℹ Running in WITHOUT_HARDWARE mode. Falling back to LittleFS logging.");
#endif
